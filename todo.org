...
** TODO Problem with circle under equibiaxial loading, including theoretical derivation 
   ...
   --- ** Notice that in solving, we start by opening the hole more than is physical and then cohesive tractions act to close it - this might be why lambda_max is overestimating?
