function [phi, phiprime,phiprime2, psi, psiprime]=farfieldpotential(theta, rho,R, m, N1, N2, omega)
...
sigma=exp(i*theta);
zeta=rho*sigma;         % Calculate the potential functions on the
                        % ellipse, since that is where we want to
                        % know displacements.
