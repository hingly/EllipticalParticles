      ...
      for strain = strainlist
        ...
        if exist(filename, 'file')
          ...
          fprintf(fid, ['%12.5e %12.5e %12.5e %12.5e %12.5e %12.5e ' ...
                        '%12.5e %d %d %12.5e\n'], data.step.macro_var.MacroStrain, ...
                  data.step.macro_var.MacroStress, data.step.symm_error, ...
                  data.converge.optim_output.iterations, ...
      ...
      for strain = strainlist
        ...
        if exist(filename, 'file')
          ...
          fprintf(fid, ['%12.5e %12.5e %12.5e %12.5e %12.5e %12.5e ' ...
                        ...
                        '%12.5e %d %d %12.5e\n'], new.step.macro_var.MacroStrain, ...
                  new.step.macro_var.MacroStress, data.step.macro_var.MacroStrain, ...
                  data.step.macro_var.MacroStress, data.step.symm_error, ...
                  data.converge.optim_output.iterations, ...
                  data.converge.optim_output.funcCount, data.converge.time);
        end
        ...
        for ii=1:5
          ...
          if exist(filename, 'file')
            ...
            fprintf(fid, ['%12.5e %12.5e %12.5e %12.5e %12.5e %12.5e ' ...
                    ...
                    new.step.macro_var.MacroStress, data.step.macro_var.MacroStrain, ...
                    data.step.macro_var.MacroStress, data.step.symm_error, ...
                    data.guess_test.ii, data.converge.optim_output.iterations, ...
                  data.converge.optim_output.funcCount, data.converge.time);
          end
