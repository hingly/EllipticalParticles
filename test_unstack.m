...
struct_out_0.Sigma_p=zeros(NumSteps, 4);
struct_out_2.Sigma_p=zeros(NumSteps, 3);
struct_check.Sigma_p = [3 2 1 1; 4 3 2 2; 5 4 3 3];
struct_check.Eps_int = [-1 -2 -3; -2 -3 -4; -3 -4 -5];

% Test for zero modes
NumModes = 0;
vector_in = [4 2 3 2 1 1 -1 -2 -3; ...
                3 -5 4 3 2 2 -2 -3 -4; ...
                0 1 5 4 3 3 -3 -4 -5];
...
% Test for two modes
NumModes = 2;
vector_in=[4 3 1 2 -1 2 3 2 1 1 -1 -2 -3; ...
             3 0 2 -5 0 6 4 3 2 2 -2 -3 -4; ...
             0 -1 2 1 -1 1 5 4 3 3 -3 -4 -5];
